...
//        list.add(new RecvDTO(R.drawable.img1, 1, "여", "고슴도치", "집"));
//        list.add(new RecvDTO(R.drawable.img2, 2, "여", "고슴도치", "집"));
//        list.add(new RecvDTO(R.drawable.img3, 3, "여", "고슴도치", "집"));
//        list.add(new RecvDTO(R.drawable.img4, 4, "여", "고슴도치", "집"));
//        list.add(new RecvDTO(R.drawable.img5, 5, "여", "고슴도치", "집"));
        return list;
    }
