...
import com.example.project01_sbntalk.databinding.ActivitySplashBinding;
...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ProgressDialog : 로딩중에 사용자가 어떤 동작을 하고 있는지를 인지를 못한 경우에는 프로그램 오류나, 버그를 의심하고 기다림을 멈춘다. => 조작
        //조작x=>앱종료 (로딩중이라는 것을 나타내기 위한 위젯을 사용해보기)
        ProgressDialog dialog = new ProgressDialog(this);
        dialog.setTitle("Sbn Talk");
