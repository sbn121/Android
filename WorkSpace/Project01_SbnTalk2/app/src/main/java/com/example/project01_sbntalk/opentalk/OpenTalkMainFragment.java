...
import com.example.project01_sbntalk.databinding.FragmentOpenTalkMainBinding;
...
public class OpenTalkMainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //jsp <-> Controller : jsp는 이미 조회가 완료된 내용을 Model을 통해서 받아와서 el문법으로 '보여주는 처리만함'.(Controller 비즈니스로직)
    ...
    ArrayList<Fragment> getFragmentList(){
        ...
        list.add(new OpenSub4Fragment(binding.pager2));
        list.add(new OpenSub4Fragment(binding.pager2));
        list.add(new OpenSub4Fragment(binding.pager2));
        list.add(new OpenSub4Fragment(binding.pager2));
        return list;
